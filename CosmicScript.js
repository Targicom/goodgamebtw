...
class Warrior
{
    ...
    DealDamage(move,target,targMove)
    {
        ...
        console.log("ATTACK MOD: " + this.attackMod)
...
player.MovePool[0] = List[14]
player.MovePool[1] = List[21]
player.MovePool[2] = List[26]
player.MovePool[3] = List[44]
player.MovePool[4] = List[40]
player.MovePool[5] = List[39]
player.MovePool[6] = List[19]
player.MovePool[7] = List[15]
player.MovePool[8] = List[9]
player.MovePool[9] = List[7]
